...
library(tidyverse)
library(janitor)
library(rsprite2) # version 0.2.1.9001, which fixed the SD limits bug, installed 2025-06-23
library(scrutiny) # version 0.3
...
dat_umbrella_tides <- umbrella(n = 14, min = 1, max = 7, n_items = 1, precision = 2) 
...
umbrella_plot(dat_umbrella_tides)
